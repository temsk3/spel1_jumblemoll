...
class IdentificationPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final model = ref.watch(identificationViewModelProvider);
    return Scaffold(
      ...
      body: model.isLoading
          ...
          : SingleChildScrollView(child: _body(context, model, appMQ)),
    );
    // },
    //   ),
    // );
  ...
  Widget _body(
    ...
    switch (status) {
      case Status.unverified:
        return _unverifiedBody(context, model, appMQ);
      case Status.verified:
        return _verifiedBody(context, model, appMQ);
      default:
        return Container();
    }
  }
